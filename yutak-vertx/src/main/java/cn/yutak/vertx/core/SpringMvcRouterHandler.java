...
import cn.yutak.vertx.anno.*;
import cn.yutak.vertx.kit.*;
import cn.yutak.vertx.template.AbstractTemplateEngineDelegate;
import cn.yutak.vertx.template.VertxTemplateEngine;
    ...
    private List<RouteInfo> extractRouteInfos(Class routeHandlerClass) {
        ...
        return Stream.of(routeHandlerClass.getMethods()).filter(method -> method.isAnnotationPresent(RouteMapping.class))
                .map(method -> {
                    ...
                    Class<? extends HttpMethod> httpMethodClass = routeMapping.method();
                    ...
                    try {
                        //set route method
                        r.setRouteMethod(httpMethodClass.newInstance());
                    } catch (Exception e) {
